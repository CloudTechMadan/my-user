...
function logout() {
  ...
  const logoutUrl = `https://face-attendance-admin-auth.auth.us-east-1.amazoncognito.com/logout?client_id=${clientId}&logout_uri=${encodeURIComponent('https://cloudtechmadan.github.io/my-user/index.html')}`;
